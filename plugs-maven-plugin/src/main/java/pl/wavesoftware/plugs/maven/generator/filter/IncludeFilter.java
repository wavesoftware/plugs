...
import pl.wavesoftware.plugs.maven.generator.model.FilterableDependency;
 ...
 * @since 0.1.0
 */
final class IncludeFilter extends AbstractDependencyFilter {

  IncludeFilter(List<Include> includes) {
    super(includes);
  }
