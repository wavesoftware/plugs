 ...
 * @since 0.1.0
 */
public final class MojoExtension
  implements BeforeAllCallback, ParameterResolver {

  private static final Namespace NAMESPACE = Namespace.create(Mojo.class);

  @Override
  public void beforeAll(ExtensionContext context) throws Exception {
    MojoRule rule = new MojoRule(new MojoDelegate());
    context.getStore(NAMESPACE).put(MojoRule.class, rule);
  }
  ...
  public boolean supportsParameter(
    ...
    return parameter
      .getType()
      .isAssignableFrom(MojoFactory.class);
  }
  ...
  public Object resolveParameter(
    ...
    return new MojoFactoryImpl(mojoRule);
  }
